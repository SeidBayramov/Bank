...
namespace Bank.Business.Services.Implementations
{
    public class SliderService : ISliderService
    {
        ...
        public async Task CreateAsync(CreateSliderVm vm,string env)
        {
            ...
            if (vm.Descriptions.Length > 2000)
            {
                throw new ValidationException("Descriptions length must be 2000 characters or less");
            }
        ...
        public async Task UpdateAsync(UpdateSliderVm vm, string webRoot)
        {
            ...
            if (oldBlog is null) throw new ObjectNullException("There is no slider in data!", nameof(oldBlog));
